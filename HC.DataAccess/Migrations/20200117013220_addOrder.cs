        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelveryDate = table.Column<DateTime>(nullable: false),
                    OrderType = table.Column<string>(maxLength: 3, nullable: true),
                    OrderStatus = table.Column<string>(maxLength: 1, nullable: true)
                },
                constraints: table =>
                {
